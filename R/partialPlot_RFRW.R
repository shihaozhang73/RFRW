partialPlot_RFRW <- function(x, ...) UseMethod("partialPlot_RFRW")

partialPlot_RFRW.default <- function(x, ...)
    stop("partial dependence plot not implemented for this class of objects.\n")

partialPlot_RFRW.RFRW <-
              ...
              ...)
{
    ...
    if (is.null(x$forest))
        stop("The RFRW object must contain the forest.\n")
